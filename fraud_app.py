...
while n < 6:
    ...
    current_month=current_month-dt.timedelta(days=30)
    n=n+1
...
def multi_cust(file):
  if file:
    ...
    cust_ID_DF['Status for next month']=cust_ID_DF['default'].apply(lambda x : 'NotDefault' if x == 0 else 'Default')
